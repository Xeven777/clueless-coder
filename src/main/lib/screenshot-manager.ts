...
export class ScreenshotManager {
  ...
  private view: 'queue' | 'solutions' | 'debug' | 'question' | 'mcq' = 'queue'

  constructor(view: 'queue' | 'solutions' | 'debug' | 'question' | 'mcq' = 'queue') {
    this.view = view
  ...
  public getView(): 'queue' | 'solutions' | 'debug' | 'question' | 'mcq' {
    return this.view
  }

  public setView(view: 'queue' | 'solutions' | 'debug' | 'question' | 'mcq'): void {
    this.view = view
  }
